var ids = {
  github: {
    ...
    callbackURL: "https://192.168.200.68:8888/auth/github/callback"
  },
  linkedin: {
    clientID: '7719rof6v75s4g',
    clientSecret: 'fM4ACEGDCVaYdNfg',
    callbackURL: "https://192.168.200.68:8888/auth/linkedin/callback"
  },
  twitter: {
  ...
  facebook: {
    ...
    callbackURL: "https://192.168.200.68:8888/auth/facebook/callback"
  },
  tumblr: {
    ...
    callbackURL: "https://192.168.200.68:8888/auth/tumblr/callback"
  },
  yahoo: {
    consumerKey: 'VlgkvmTCPPA1iwvoi5Ey5Py5y4odGruJV6SH17SjuPBcvNYtvS',
    consumerSecret: 'BS9AsDtIdp8ZfSrxy5nxxOMpBIcExqTK1xdZH5xAu4FCuqbQKW',
    returnURL: "https://192.168.200.68:8888/auth/yahoo/callback"
  },
  google: {
